...
$(window).load(function () {
  ...
  document.querySelectorAll('.con').forEach(function (r, o) {
    ...
    gsap.fromTo(
      ...
      { opacity: 0 }, // 初期状態（透明）
      {
        ...
        scrollTrigger: {
          ...
          id: 'o-' + (o + 1), // 識別用ID(デバッグ用マーカー使用時に必要)
        },
      }
    );
    ...
    ScrollTrigger.create({
      ...
      pinSpacing: false,
      markers: false,
      id: 't-' + (o + 1), // 識別用ID(デバッグ用マーカー使用時に必要)
    });
    ...
    ScrollTrigger.create({
      ...
      pinSpacing: false,
      markers: false,
      id: 'b-' + (o + 1), // 識別用ID(デバッグ用マーカー使用時に必要)
    });

    // #feature に対して動的にクラスを切り替える
