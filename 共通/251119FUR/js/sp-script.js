...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //     tapAnimeContainer.style.transition = ''; // transitionを初期状態に戻す
...
function setupGsap() {
  ...
  const centerContainer = document.querySelector('.container01__sec02');
  if (!centerContainer) {
    console.error("基準要素 '.container01__sec02' が見つかりません。");
    return;
  }
